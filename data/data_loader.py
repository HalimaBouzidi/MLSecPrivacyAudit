...
def build_default_MNIST_data_loader(args):
    ...
    if args.distributed == 'True' and getattr(args, 'distributed_val', 'True'):
...
def build_default_CIFAR10_dataset(args):
    ...
    train_dataset = CIFAR10(root=args.dataset_dir, train=True,
...
def build_default_CIFAR100_dataset(args):
    ...
    train_dataset = CIFAR100(root=args.dataset_dir, train=True,
                                        download=True, transform=train_transforms)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='TINY-IMAGENET', choices=['MNIST', 'CIFAR10', 'CIFAR100', 'TINY-IMAGENET', 'IMAGENET'])
    parser.add_argument('--dataset_dir', type=str, default='./datasets/tiny-imagenet', help='Path to the dataset folder')
    ...
    train_loader, val_loader, train_sampler = build_data_loader(run_args)
